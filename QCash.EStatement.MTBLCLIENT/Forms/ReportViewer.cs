...
namespace StatementGenerator
{
    public partial class ReportViewer : Form
    {
        ...
        void grdEmailData_InitializeLayout(object sender, Infragistics.Win.UltraWinGrid.InitializeLayoutEventArgs e)
        {
            ...
            //
            e.Layout.Bands[0].Columns["IDCLIENT"].Header.Caption = "CLIENT ID";
            e.Layout.Bands[0].Columns["IDCLIENT"].Width = 70;
            e.Layout.Bands[0].Columns["IDCLIENT"].CellActivation = Activation.ActivateOnly;
            //
            e.Layout.Bands[0].Columns["CLIENT"].Header.Caption = "CLIENT NAME";
            e.Layout.Bands[0].Columns["CLIENT"].Width = 70;
            e.Layout.Bands[0].Columns["CLIENT"].CellActivation = Activation.ActivateOnly;
            //
            ...
            //
            e.Layout.Bands[0].Columns["FILE_LOCATION"].Header.Caption = "Server File \nLocation";
            ...
            e.Layout.Bands[0].Columns["FILE_LOCATION_CLIENT"].Header.Caption = "Client File \nLocation";
            e.Layout.Bands[0].Columns["FILE_LOCATION_CLIENT"].Width = 100;
            e.Layout.Bands[0].Columns["FILE_LOCATION_CLIENT"].CellActivation = Activation.ActivateOnly;
            //
        ...
        void SendEmail()
        {
           ...
           // string ClientIP = string.Empty;
            string ClientPcName = Dns.GetHostName(); // Retrive the Name of HOST
                                ...
                                for (int i = 0; i < objESList.Count; i++)
                                {
                                    if (objESList[i].MAILADDRESS != "")
                                    {
                                        try
                                        {
                                            ...
                                            txtAnalyzer.Invoke(_addText, new object[] { System.DateTime.Now.ToString("MMMM dd, yyyy h:mm:tt") + " : " + "Sending EStatement to " + mail.To.ToString() + "  From  PC Name : " + ClientPcName }); ;
                                            objLW.logTrace(_LogPath, "EStatement.log", System.DateTime.Now.ToString("MMMM dd, yyyy h:mm:tt") + " : Sending EStatement " + mail.To.ToString() + "  From  PC Name : " + ClientPcName );
                                    ...
                                    {
                                        txtAnalyzer.Invoke(_addText, new object[] { System.DateTime.Now.ToString("MMMM dd, yyyy h:mm:tt") + " : " + "No Mail Address Found to send the Estatement " + objESList[i].FILE_LOCATION_CLIENT }); ;
                                        objLW.logTrace(_LogPath, "EStatement.log", System.DateTime.Now.ToString("MMMM dd, yyyy h:mm:tt") + " : No Mail Address Found to send the Estatement " + objESList[i].FILE_LOCATION_CLIENT);
