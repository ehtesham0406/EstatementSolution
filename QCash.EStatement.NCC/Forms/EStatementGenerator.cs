...
using QCash.EStatement.NCC.Reports;
...
namespace StatementGenerator
{
    public partial class EStatementGenerator : Form
    {
                                    ...
                                    try
                                    {
                                        ...
                                        if ((dtCards.Rows[j]["pan"].ToString()) != vPAN)
                                        {
                                            ...
                                            if (stmdt.Rows.Count > 0)
                                            {
                                                ...
                                                //if (dtCards.Rows[j]["INDICATOR"].ToString() == "C")
                                                //{

                                                CEStatement objst = new CEStatement();
                                              ...
                                              //  fileName = _fiid + "_" + dtCards.Rows[j]["pan"].ToString().Substring(0, 6) + "_" + stmdt.Rows[0]["Statement_Date"].ToString().Replace('/', '-') + '_' + pdfCount + ".pdf";
                                                ...
                                                for (int i = 0; i < document.Pages.Count; ++i)
                                                {
                                                    ...
                                                    XRect layoutRectangle = new XRect(249 /*X*/ , 198 /*Y*/ , page.Width /*Width*/ , font.Height /*Height*/ );
                                                    using (XGraphics gfx = XGraphics.FromPdfPage(page))
                                                    {
                                                        //gfx.DrawString("Page " + (i + 1).ToString() + " of " + noPages, font, brush, layoutRectangle, XStringFormats.Center);

                                                        //gfx.DrawString("Page " + (i + 1).ToString() +"of"+ noPages + font, brush, layoutRectangle, XStringFormats.Center);
                                                       // gfx.DrawString((i + 1).ToString() + "-" + TPages, font, brush, layoutRectangle, XStringFormats.Center);

                                                        gfx.DrawString((i + 1).ToString() + "" + noPages, font, brush, layoutRectangle, XStringFormats.Center);
        ...
        private void ProcessData()
        {
            ...
            {
                if (dia[fcount].FullName.Contains("MDBL"))
                {
                    _bankName = "MDBL";
                    _bankCode = "3";
                ...
                else if (dia[fcount].FullName.Contains("NCC"))
                {
                    _bankName = "NCC";
                    _bankCode = "30";
                    _XMLSourcePath = dia[fcount].FullName;
            ...
            try
            {
                ...
                for (int k = 0; k < dtStatement.Rows.Count; k++)
                {
                    ...
                    sql = "Insert into Statement(BANK_CODE,STATEMENTNO,ADDRESS,CARD_LIST,CITY,COUNTRY,EMAIL," +
                          ...
                          "NEXT_STATEMENT_DATE,PAYMENT_DATE,REGION,STATEMENT_DATE,SEX,STREETADDRESS,TELEPHONE,TITLE,ZIP,PROMOTIONALTEXT,INDICATOR) " +
                          ...
                          "'" + objSt.TELEPHONE + "','" + objSt.TITLE + "','" + objSt.ZIP + "','" + objSt.PROMOTIONALTEXT + "','" + objSt.INDICATOR + "')";
            ...
            for (int k = 0; k < dtStatement.Rows.Count; k++)
            {
                ...
                try
                {
                    ...
                    for (int j = 0; j < dtStatement.Columns.Count; j++)
                    {
                       ...
                       // else if (dtStatement.Columns[j].ColumnName.ToUpper() == "ADDRESS")
                        ...
                        if (dtStatement.Columns.Contains("ADDRESS"))
                        {
                            ...
                            if (!string.IsNullOrEmpty(lines[0]))
                            {
                                objSt.INDICATOR = lines[0].Trim();
                            }
                        //     <PromotionalText>C|NATIONAL BANK LTD.||BHBFC BHTAN GR.FLOOR|KHULNA|  |Khulna  BD</PromotionalText>

                            if (objSt.INDICATOR == "C")
                            {
                                if (!string.IsNullOrEmpty(lines[1].Trim()))
                                {
                                    objSt.ADDRESS = lines[1].Trim() + '|';
                                }

                                if (!string.IsNullOrEmpty(lines[2].Trim()))
                                {
                                    objSt.ADDRESS = objSt.ADDRESS+lines[2].Trim() + '|';
                                }

                                if (!string.IsNullOrEmpty(lines[3].Trim()))
                                {
                                    objSt.ADDRESS = objSt.ADDRESS + lines[3].Trim() + '|';
                                }
                                if (!string.IsNullOrEmpty(lines[4].Trim()))
                                {
                                    objSt.ADDRESS = objSt.ADDRESS + lines[4].Trim() + '|';
                                }
                                if (!string.IsNullOrEmpty(lines[5].Trim()))
                                {
                                    objSt.ADDRESS = objSt.ADDRESS + lines[5].Trim() + '|';
                                }
                                if (!string.IsNullOrEmpty(lines[6].Trim()))
                                {
                                    objSt.ADDRESS = objSt.ADDRESS + lines[6].Trim();
                                }


                              //  objSt.ADDRESS = lines[1].Trim() + '|' + lines[2].Trim() + '|' + lines[3].Trim() + '|' + lines[4].Trim() + '|' + lines[5].Trim() + '|' + lines[6].Trim();
                    ...
                    sql = "Insert into STATEMENT_INFO(STATEMENTID,BANK_CODE,CONTRACTNO,IDCLIENT,PAN,TITLE,CLIENTNAME,JOBTITLE,STATEMENTNO,ADDRESS,CITY,ZIP,COUNTRY," +
                        ...
                        "MIN_AMOUNT_DUE,CASH_LIMIT,CRD_LIMIT,STM_MSG,STATUS,PROMOTIONALTEXT,INDICATOR) VALUES('" + objSt.STATEMENTID + "'," +
                        ...
                        "'" + objSt.CRD_LIMIT + "','" + objSt.STM_MSG + "','" + objSt.STATUS + "','" + objSt.PROMOTIONALTEXT + "','" + objSt.INDICATOR + "')";
