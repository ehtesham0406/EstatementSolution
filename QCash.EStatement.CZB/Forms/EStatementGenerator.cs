...
using QCash.EStatement.CZB;
using CrystalDecisions.CrystalReports.Engine;
using FlexiStar.Utilities.EncryptionEngine;
using QCash.EStatement.CZB.Reports;
...
namespace StatementGenerator
{
    public partial class EStatementGenerator : Form
    {
            ...
            if (ds != null)
            {
                if (ds.Tables.Count > 0)
                {
                    if (ds.Tables[0].Rows.Count > 0)
                    {
                        ...
                        {
                            //if (dtCards.Rows[j]["EMAIL"].ToString().Trim() != "")  No email check [Bank Requirement]
                            //{
                            // if (IsValid(dtCards.Rows[j]["EMAIL"].ToString().Trim()))  No email check [Bank Requirement]
                            //{
                            try
                            {
                                pdfCount = pdfCount + 1;
        ...
        private void ProcessData()
        {
            ...
            {
                if (dia[fcount].FullName.Contains("CZB"))
                {
                    _bankName = "CZB";
                    _bankCode = "1";
            ...
            for (int k = 0; k < dtStatement.Rows.Count; k++)
            {
                ...
                try
                {
                    ...
                    for (int j = 0; j < dtStatement.Columns.Count; j++)
                    {
                        ...
                        #region Home Address , Company Address, Company Name, Company Job Title
                        ...
                        else if (dtStatement.Columns[j].ColumnName.ToUpper() == "PROMOTIONALTEXT")
                        {
                            ...
                            {
                                if (!string.IsNullOrEmpty(lines[1]))   // Company Name
                                {
                                    objSt.COMPANYNAME = lines[1];
                                }

                                if (!string.IsNullOrEmpty(lines[2]))   // Company Job Title
                                {
                    ...
                    sql = "Insert into STATEMENT_INFO(STATEMENTID,BANK_CODE,CONTRACTNO,IDCLIENT,PAN,TITLE,CLIENTNAME,STATEMENTNO,ADDRESS,CITY,ZIP,COUNTRY," +
                        ...
                        "MIN_AMOUNT_DUE,CASH_LIMIT,CRD_LIMIT,STM_MSG,STATUS,JOBTITLE,INSTALL_UNPAID_AMOUNT,INSTALL_MONTH_PAYM,COMPANYNAME,INDICATOR,COMPANYADDRESS1,COMPANYADDRESS2,COMPANYADDRESS3) VALUES('" + objSt.STATEMENTID + "'," +
                        ...
                        "'" + objSt.CRD_LIMIT + "','" + objSt.STM_MSG + "','" + objSt.STATUS + "','" + objSt.JOBTITLE + "','" + objSt.INSTALL_UNPAID_AMOUNT + "','" + objSt.INSTALL_MONTH_PAYM + "','" + objSt.COMPANYNAME + "','" + objSt.INDICATOR + "','" + objSt.COMPANYADDRESS1 + "','" + objSt.COMPANYADDRESS2 + "','" + objSt.COMPANYADDRESS3 + "')";
                            ...
                            if (dr.Length > 0)
                            {
                                ...
                                for (int l = 0; l < dr.Length; l++)
                                {
                                    ...
                                    if (INTlist.Contains(dr[l]["D"].ToString().ToUpper()) == false)
                                    {
                                        ...
                                        #region  #region CARD ANNUAL FEE  //CHNG
            ...
            for (int k = 0; k < dtStatement.Rows.Count; k++)
            {
                ...
                try
                {
                    ...
                    sql = "Insert into STATEMENT_INFO(STATEMENTID,BANK_CODE,CONTRACTNO,IDCLIENT,PAN,TITLE,CLIENTNAME,STATEMENTNO,ADDRESS,CITY,ZIP,COUNTRY," +
                        "EMAIL,MOBILE,STARTDATE,ENDDATE,NEXT_STATEMENT_DATE,PAYMENT_DATE,STATEMENT_DATE,ACCOUNTNO,ACURN,SBALANCE,ACURC,EBALANCE,AVAIL_CRD_LIMIT," +
                        "AVAIL_CASH_LIMIT,SUM_WITHDRAWAL,SUM_INTEREST,OVLFEE_AMOUNT,OVDFEE_AMOUNT,SUM_REVERSE,SUM_CREDIT,SUM_OTHER,SUM_PURCHASE," +
                        "MIN_AMOUNT_DUE,CASH_LIMIT,CRD_LIMIT,STM_MSG,STATUS,INSTALL_UNPAID_AMOUNT,INSTALL_MONTH_PAYM,JOBTITLE,COMPANYNAME,INDICATOR,COMPANYADDRESS1,COMPANYADDRESS2,COMPANYADDRESS3) VALUES('" + objSt.STATEMENTID + "'," +
                        "'" + objSt.BANK_CODE + "','" + objSt.CONTRACTNO + "','" + objSt.IDCLIENT + "','" + objSt.PAN + "','" + objSt.TITLE + "','" + objSt.CLIENTNAME + "','" + objSt.STATEMENTNO + "'," +
                        "'" + objSt.ADDRESS + "','" + objSt.CITY + "','" + objSt.ZIP + "','" + objSt.COUNTRY + "','" + objSt.EMAIL + "','" + objSt.MOBILE + "','" + objSt.STARTDATE + "','" + objSt.ENDDATE + "'," +
                        "'" + objSt.NEXT_STATEMENT_DATE + "','" + objSt.PAYMENT_DATE + "','" + objSt.STATEMENT_DATE + "','" + objSt.ACCOUNTNO + "','" + objSt.ACURN + "'," +
                        "'" + objSt.SBALANCE + "','" + objSt.ACURC + "','" + objSt.EBALANCE + "','" + objSt.AVAIL_CRD_LIMIT + "','" + objSt.AVAIL_CASH_LIMIT + "'," +
                        "'" + objSt.SUM_WITHDRAWAL + "','" + objSt.SUM_INTEREST + "','" + objSt.OVLFEE_AMOUNT + "','" + objSt.OVDFEE_AMOUNT + "','" + objSt.SUM_REVERSE + "'," +
                        "'" + objSt.SUM_CREDIT + "','" + objSt.SUM_OTHER + "','" + objSt.SUM_PURCHASE + "','" + objSt.MIN_AMOUNT_DUE + "','" + objSt.CASH_LIMIT + "'," +
                        "'" + objSt.CRD_LIMIT + "','" + objSt.STM_MSG + "','" + objSt.STATUS + "','" + objSt.INSTALL_UNPAID_AMOUNT + "','" + objSt.INSTALL_MONTH_PAYM + "','" + objSt.JOBTITLE + "','" + objSt.COMPANYNAME + "','" + objSt.INDICATOR + "','" + objSt.COMPANYADDRESS1 + "','" + objSt.COMPANYADDRESS2 + "','" + objSt.COMPANYADDRESS3 + "')";
