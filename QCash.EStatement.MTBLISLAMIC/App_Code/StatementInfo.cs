...
namespace StatementGenerator
{
    public class StatementInfo
    {
        ...
        private string _INSTALL_UNPAID_AMOUNT;

        public string INSTALL_UNPAID_AMOUNT
        {
            get { return _INSTALL_UNPAID_AMOUNT; }
            set { _INSTALL_UNPAID_AMOUNT = value; }
        }
        private string _INSTALL_MONTH_PAYM;

        public string INSTALL_MONTH_PAYM
        {
            get { return _INSTALL_MONTH_PAYM; }
            set { _INSTALL_MONTH_PAYM = value; }
        }
        ...
        private string _MMFBDTBALANCE;

        public string MMFBDTSBALANCE
        {
            get { return _MMFBDTBALANCE; }
            set { _MMFBDTBALANCE = value; }
        }

        private string _MMFUSDBALANCE;

        public string MMFUSDSBALANCE
        {
            get { return _MMFUSDBALANCE; }
            set { _MMFUSDBALANCE = value; }
        }
