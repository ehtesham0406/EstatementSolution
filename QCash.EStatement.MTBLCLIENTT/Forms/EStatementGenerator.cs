...
using QCash.EStatement.MTBLCLIENTT.Reports;
using Infragistics.Documents.PDF;
using PdfSharp.Pdf.IO;
using PdfSharp.Pdf;
using PdfSharp.Pdf.Security;
using Common;
using QCash.EStatement.MTBL.App_Code;
using System.Xml;
...
namespace StatementGenerator
{
    public partial class EStatementGenerator : Form
    {
        ...
        private string _XMLClientPath = string.Empty;
        ...
        //                                    XMLField objxmlfield = new XMLField();
        //                                    string template_string = File.ReadAllText(_Mail + @"\\Template.html");


        //                                    // Console.WriteLine("Contents of WriteText.txt = {0}", template_string);
        //                                    XmlDocument doc = new XmlDocument();
        //                                    doc.Load(_Mail + @"\\TemplateSettings.xml");
        //                                    DataSet ds = new DataSet();
        //                                    ds.ReadXml(new XmlTextReader(new StringReader(doc.InnerXml)));
        //                                    if (ds.Tables.Count > 0)
        //                                    {
        //                                        objxmlfield.contentfirst_image = ds.Tables[0].Rows[0]["image"].ToString();
        //                                        objxmlfield.contentfirst_header = ds.Tables[0].Rows[0]["header"].ToString();
        //                                        objxmlfield.contentfirst_textbody = ds.Tables[0].Rows[0]["textbody"].ToString();
        //                                        objxmlfield.contentfirst_showmore = ds.Tables[0].Rows[0]["showmore"].ToString();

        //                                        objxmlfield.contentsecond_image = ds.Tables[1].Rows[0]["image"].ToString();
        //                                        objxmlfield.contentsecond_header = ds.Tables[1].Rows[0]["header"].ToString();
        //                                        objxmlfield.contentsecond_textbody = ds.Tables[1].Rows[0]["textbody"].ToString();
        //                                        objxmlfield.contentsecond_showmore = ds.Tables[1].Rows[0]["showmore"].ToString();


        //                                        objxmlfield.contenthird_image = ds.Tables[2].Rows[0]["image"].ToString();
        //                                        objxmlfield.contenthird_header = ds.Tables[2].Rows[0]["header"].ToString();
        //                                        objxmlfield.contenthird_textbody = ds.Tables[2].Rows[0]["textbody"].ToString();
        //                                        objxmlfield.contenthird_showmore = ds.Tables[2].Rows[0]["showmore"].ToString();


        //                                    }
        //                                    template_string = template_string.Replace("##image01##", objxmlfield.contentfirst_image)
        //                                                   .Replace("##header01##", objxmlfield.contentfirst_header)
        //                                                   .Replace("##textbody01##", objxmlfield.contentfirst_textbody)
        //                                                   .Replace("##showmore01##", objxmlfield.contentfirst_showmore)
        //                                                   .Replace("##image02##", objxmlfield.contentsecond_image)
        //                                                   .Replace("##header02##", objxmlfield.contentsecond_header)
        //                                                   .Replace("##textbody02##", objxmlfield.contentsecond_textbody)
        //                                                   .Replace("##showmore02##", objxmlfield.contentsecond_showmore)
        //                                                   .Replace("##image03##", objxmlfield.contenthird_image)
        //                                                   .Replace("##header03##", objxmlfield.contenthird_header)
        //                                                   .Replace("##textbody03##", objxmlfield.contenthird_textbody)
        //                                                   .Replace("##showmore03##", objxmlfield.contenthird_showmore);
        //                                 //   File.WriteAllText(_Mail + @"\\\Template.html", template_string);
                                ...
                                for (int i = 0; i < objESList.Count; i++)
                                {
                                    if (objESList[i].MAILADDRESS != "")
                                    {
                                        try
                                        {
                                            ...
                                            mail.To.Add(objESList[i].MAILADDRESS.Trim());
                                            System.Net.Mail.Attachment attachment;
                                            attachment = new System.Net.Mail.Attachment(objESList[i].FILE_LOCATION_CLIENT);
                                            mail.Attachments.Add(attachment);
        ...
        void btnGenerate_Click(object sender, EventArgs e)
        {
            ...
            dtCardbdt = dataHandler.DBOracleManupulation.RecordSet("select * from Qry_Card_Account");// where Curr='BDT'
        ...
        private void ProcessStatementBDT(DataTable dtCards)
        {
            ...
            string filePathClient = string.Empty;
           ...
           // ConStr = new ConnectionStringBuilder(1);
           // objProvider = new SqlDbProvider(ConStr.ConnectionString_DBConfig);
            ds = dataHandler.DBOracleManupulation.RecordSetCollection("select * from Statement_DUAL", reply);
            MsgLogWriter objLW = new MsgLogWriter();
                ...
                if (ds.Tables.Count > 0)
                {
                    if (ds.Tables[0].Rows.Count > 0)
                    {
                       ...
                       // if (!Directory.Exists(_EStatementProcessedPath))
                        ...
                        filePathClient = _XMLClientPath + "\\EStatement of " + System.DateTime.Now.ToString("ddMMyyyy");

                        if (!Directory.Exists(filePathClient))
                            Directory.CreateDirectory(filePathClient);
                            ...
                            if (dtCards.Rows[j]["EMAIL"].ToString().Trim() != "")
                            {
                                if (IsValid(dtCards.Rows[j]["EMAIL"].ToString().Trim()))
                                {
                                    ...
                                    try
                                    {
                                        pdfCount = pdfCount + 1;
                                        stmdt = new DataTable();
                                        //  string a="select * from Statement_DUAL where CONTRACTNO='" + dtCards.Rows[j]["CONTRACTNO"].ToString() + "' ORDER BY SL,AutoID";
                                        stmdt = dataHandler.DBOracleManupulation.RecordSet("select * from Statement_DUAL where CONTRACTNO='" + dtCards.Rows[j]["CONTRACTNO"].ToString() + "' ORDER BY SL,AutoID");
                                        if ((dtCards.Rows[j]["pan"].ToString()) != vPAN)
                                        {
                                            ...
                                            if (stmdt.Rows.Count > 0)
                                            {
                                                ...
                                                fileName = "MTB" + "_" + dtCards.Rows[j]["pan"].ToString().Substring(0, 4) + "_" + dtCards.Rows[j]["idclient"].ToString() + "_" + stmdt.Rows[0]["Statement_Date"].ToString().Replace('/', '-') + '_' + pdfCount + ".pdf";
                                                ...
                                                // Save the document...
                                                document.Save(filePathClient + "\\" + fileName);
                                                ...
                                                objEst.STATUS = "1";
                                                objEst.FILE_LOCATION_CLIENT = filePathClient + "\\" + fileName;
        ...
        void ReportViewer_Load(object sender, EventArgs e)
        {
            ...
            _XMLClientPath = ConfigurationManager.AppSettings[10].ToString();
        ...
        private void ProcessData()
        {
            ...
            {
                if (dia[fcount].FullName.Contains("MTBL"))
                {
                    _bankName = "MTBL";
                    _bankCode = "3";
        ...
        private void ProcessFolderFiles(string _SourcePath, string BankCode, string BankName, ref string _reply)
        {
            ...
            try
            {
                        ...
                        if (dsXML != null)
                        {
                            if (dsXML.Tables.Count > 0)
                            {
                               // ConStr = new ConnectionStringBuilder(1);
                                ...
                                dbHelper.DBOracleManupulation.Execute(" Delete from  AccumIntAcc ", UUL.UDBH.QuaryType.Complex);
                                //Clear Previous BonusContrAcc Data
                                //objProvider.RunQuery("Delete from  BonusContrAcc");
                                dbHelper.DBOracleManupulation.Execute(" Delete from  BonusContrAcc ", UUL.UDBH.QuaryType.Complex);
                               // objProvider.RunQuery("insert into statement_info_arc select * from statement_info");
                                dbHelper.DBOracleManupulation.Execute(" insert into statement_info_arc select * from statement_info ", UUL.UDBH.QuaryType.Complex);

                              //  objProvider.RunQuery("insert into statement_details_arc select * from statement_details");
                                dbHelper.DBOracleManupulation.Execute(" insert into statement_details_arc select * from statement_details ", UUL.UDBH.QuaryType.Complex);

                                dbHelper.DBOracleManupulation.Execute(" insert into EMAIL_NOTIFICATION_ARC select * from EMAIL_NOTIFICATION ", UUL.UDBH.QuaryType.Complex);

                                // objProvider.RunQuery("Delete from  statement_info");
                                dbHelper.DBOracleManupulation.Execute(" Delete from  statement_info ", UUL.UDBH.QuaryType.Complex);

                                //objProvider.RunQuery("Delete table  statement_details");
                                dbHelper.DBOracleManupulation.Execute(" Delete from  statement_details ", UUL.UDBH.QuaryType.Complex);

                                dbHelper.DBOracleManupulation.Execute(" Delete from  EMAIL_NOTIFICATION ", UUL.UDBH.QuaryType.Complex);

                                OracleCommand cmd = new OracleCommand();
                                cmd.Parameters.Add(new OracleParameter("p_seq_name", "SEQ_TEST_ID"));

                                dataHandler.DBOracleManupulation.SPExecute("reset_seq", cmd);
                                ...
                                for (int i = 0; i < dsXML.Tables.Count; i++)
                                {
                                    ...
                                    else if (dsXML.Tables[i].TableName == "BonusContrAcc")
                                    {
                                        ...
                                        txtAnalyzer.Invoke(_addText, new object[] { System.DateTime.Now.ToString("MMMM dd, yyyy h:mm:tt") + " : CardHolder Reward Info data Saved from XML. " + reply });
                                    ...
                                    else if (dsXML.Tables[i].TableName == "AccumIntAcc")
                                    {
                                        ...
                                        txtAnalyzer.Invoke(_addText, new object[] { System.DateTime.Now.ToString("MMMM dd, yyyy h:mm:tt") + " : CardHolder Suspense Account Info data Saved from XML. " + reply });
                ...
                //else 
                //{
                //    txtAnalyzer.Invoke(_addText, new object[] { System.DateTime.Now.ToString("MMMM dd, yyyy h:mm:tt") + " More than one XML found to process.." });
                //}
        ...
        private StatementList GetCardHolderPersonalInfo(DataTable dtStatement, string BankCode, ref string errMsg)
        {
            ...
            try
            {
               ...
               // objProvider.RunQuery("Delete from " + dtStatement.TableName);
                dbHelper.DBOracleManupulation.Execute(" Delete from " + dtStatement.TableName, UUL.UDBH.QuaryType.Complex);
                ...
                for (int k = 0; k < dtStatement.Rows.Count; k++)
                {
                    ...
                    query = "Insert into Statement(BANK_CODE,STATEMENTNO,ADDRESS,CARD_LIST,CITY,COUNTRY,EMAIL," +
                   ...
                   // reply = objProvider.RunQuery(sql);
                    result = dbHelper.DBOracleManupulation.Execute(query, UUL.UDBH.QuaryType.Complex);
        ...
        private string GetCardHolderTransactionInfo(DataTable dtOperation)
        {
            ...
            try
            {
               ...
               // objProvider.RunQuery("Delete from " + dtOperation.TableName);
                dbHelper.DBOracleManupulation.Execute(" Delete from " + dtOperation.TableName, UUL.UDBH.QuaryType.Complex);
                ...
                for (int k = 0; k < dtOperation.Rows.Count; k++)
                {
                    ...
                    query = "Insert into Operation(STATEMENTNO,O,OD,TD,A,ACURC,ACURN,D,DE,P,OA,OCC,OC,TL,TERMN,CF,S,MN,DOCNO,NO,ACCOUNT,ACC,FR,APPROVAL,AMOUNTSIGN) " +
        ...
        private string GetBonusContrAccInfo(DataTable dtBonusContrAcc)
        {
           ...
           // string sql = string.Empty;
            ...
            try
            {
                ...
                dbHelper.DBOracleManupulation.Execute(" Delete from " + dtBonusContrAcc.TableName, UUL.UDBH.QuaryType.Complex);
                ...
                for (int k = 0; k < dtBonusContrAcc.Rows.Count; k++)
                {
                    ...
                    query = "Insert into BONUSCONTRACC(STATEMENTNO,SUM_CREDIT,SUM_DEBIT,EBALANCE,ACCOUNT_NO,ACURN,ACURC,SBALANCE) " +
        ...
        private string GetAccumIntAcc(DataTable dtGetAccumIntAcc)
        {
           ...
           // string sql = string.Empty;
            ...
            try
            {
                ...
                dbHelper.DBOracleManupulation.Execute(" Delete from " + dtGetAccumIntAcc.TableName, UUL.UDBH.QuaryType.Complex);
                ...
                for (int k = 0; k < dtGetAccumIntAcc.Rows.Count; k++)
                {
                    ...
                    query = "Insert into AccumIntAcc(STATEMENTNO,ACCUM_INT_RRELEASE,ACCUM_INT_EBALANCE,ACCUM_INT_SBALANCE,ACCUM_INT_AMOUNT,ACCOUNT_NO) " +
        ...
        private string GetCardHolderAccountInfo(DataTable dtAccount)
        {
            ...
            try
            {
              ...
              //  objProvider.RunQuery("Delete from " + dtAccount.TableName);
                dbHelper.DBOracleManupulation.Execute(" Delete from " + dtAccount.TableName, UUL.UDBH.QuaryType.Complex);
                objAc = new Account();
               

                for (int k = 0; k < dtAccount.Rows.Count; k++)
                {
                    objAc.INSTALL_UNPAID_AMOUNT = "0.00";
                    for (int j = 0; j < dtAccount.Columns.Count; j++)
                    {
                        ...
                        {
                            if (dtAccount.Rows[k][j].ToString() == "")
                            {
                            }
                            else
                            {
                    ...
                    query = "Insert into Account(STATEMENTNO,ACCOUNTNO,ACURN,SBALANCE,ACURC,EBALANCE,AVAIL_CRD_LIMIT,AVAIL_CASH_LIMIT," +
                        "SUM_WITHDRAWAL,SUM_INTEREST,OVLFEE_AMOUNT,OVDFEE_AMOUNT,SUM_REVERSE,SUM_CREDIT,SUM_OTHER,SUM_PURCHASE,MIN_AMOUNT_DUE,CASH_LIMIT,CRD_LIMIT,INSTALL_UNPAID_AMOUNT)" +
                        ...
                        "'" + objAc.SUM_CREDIT + "','" + objAc.SUM_OTHER + "','" + objAc.SUM_PURCHASE + "','" + objAc.MIN_AMOUNT_DUE + "','" + objAc.CASH_LIMIT + "','" + objAc.CRD_LIMIT + "','" + objAc.INSTALL_UNPAID_AMOUNT + "')";
        ...
        private string GetCardHolderCardInfo(DataTable dtCard)
        {
            ...
            try
            {
               ...
               // objProvider.RunQuery("Delete from " + dtCard.TableName);
                dbHelper.DBOracleManupulation.Execute(" Delete from " + dtCard.TableName, UUL.UDBH.QuaryType.Complex);
                ...
                for (int k = 0; k < dtCard.Rows.Count; k++)
                {
                    ...
                    query = "Insert into Card(STATEMENTNO,PAN,MBR,CLIENTNAME,SLNO)" +
        ...
        private void GenerateStatementInfo(DataSet dsStatement,string BankName, ref string errMsg)
        {
            ...
            try
            {
                ...
                //DataSet dsBDT = new DataSet();

                DataSet dsBDT = new DataSet();
                dsBDT = dbHelper.DBOracleManupulation.RecordSetCollection("select * from Qry_Card_Account where Curr='BDT'", reply);
                ...
                DataSet dsUSD = dbHelper.DBOracleManupulation.RecordSetCollection("select * from Qry_Card_Account where Curr='USD'", reply);
            ...
            for (int k = 0; k < dtStatement.Rows.Count; k++)
            {
                try
                {
                    ...
                    for (int j = 0; j < dtStatement.Columns.Count; j++)
                    {
                        ...
                        {
                            //if (dtStatement.Row[k].Columns[j].ToString() = 0)
                    ...
                    query = "Insert into STATEMENT_INFO(STATEMENTID,BANK_CODE,CONTRACTNO,IDCLIENT,PAN,TITLE,CLIENTNAME,STATEMENTNO,ADDRESS,CITY,ZIP,COUNTRY," +
                        ...
                        "MIN_AMOUNT_DUE,CASH_LIMIT,CRD_LIMIT,STM_MSG,STATUS,INSTALL_UNPAID_AMOUNT) VALUES('" + objSt.STATEMENTID + "'," +
                        ...
                        "'" + objSt.CRD_LIMIT + "','" + objSt.STM_MSG + "','" + objSt.STATUS + "','" + objSt.INSTALL_UNPAID_AMOUNT + "')";
                   ...
                   // reply = objProvider.RunQuery(sql);
                    ...
                    if (dtOperation != null && dtOperation.Columns.Contains("ACCOUNT"))
                    {
                        if (dtOperation.Rows.Count > 0)
                        {
                            ...
                            if (dr.Length > 0)
                            {
                                ...
                                {
                                    #region setting properties values
                                    List<string> INTlist = new List<string>() { "MARK UP PROFIT(R)", "MARK UP PROFIT (R)", "MARK UP PROFIT (R) (REVERSE)", "INTEREST ON FEES & CHARGES", "INTEREST ON INTEREST", "INTEREST CHARGE", "INTEREST ON ATM TRANSACTION", "INTEREST ON POS TRANSACTION", "INTEREST ON CARD CHEQUE", "CHARGE INTEREST FOR 0", "CHARGE INTEREST FOR 1", "CHARGE INTEREST FOR 2", "CHARGE INTEREST FOR 3", "CHARGE INTEREST FOR 4", "CHARGE INTEREST FOR 5", "CHARGE INTEREST FOR 6", "CHARGE INTEREST FOR 7", "CHARGE INTEREST FOR 8", "CHARGE INTEREST FOR 9", "CHARGE INTEREST FOR 10", "CHARGE INTEREST FOR 11", "CHARGE INTEREST FOR 12", "CHARGE INTEREST FOR 13", "CHARGE INTEREST FOR 0 OPERATIONS GROUP", "CHARGE INTEREST FOR 1 OPERATIONS GROUP", "CHARGE INTEREST FOR 2 OPERATIONS GROUP", "CHARGE INTEREST FOR 3 OPERATIONS GROUP", "CHARGE INTEREST FOR 4 OPERATIONS GROUP", "CHARGE INTEREST FOR 5 OPERATIONS GROUP", "CHARGE INTEREST FOR 6 OPERATIONS GROUP", "CHARGE INTEREST FOR 7 OPERATIONS GROUP", "INTEREST ON FUND TRANSFER", "INTEREST ON BALANCE TRANSFER", "INTEREST ON EMI", "INTEREST ON FT", "INTEREST ON BT", "INTEREST ON BANK POS TRANSACTION", "REVOLVING INTEREST CHARGE", "LATE PAYMENT CHARGE FOR GROUP 1", "LATE PAYMENT CHARGE FOR GROUP 2", "LATE PAYMENT CHARGE FOR GROUP 3", "CHARGE OF A DEBT FOR CREDIT OVERDRAFTING", "CHARGE OF A DEBT FOR CREDIT OVERDRAFTING" };
                                    if (INTlist.Contains(dr[l]["D"].ToString().ToUpper()) == false)
                                    {
                                        ...
                                        if (dr[l].Table.Columns.Contains("OCC"))
                                        {
                                            ...
                                            dtOcc = dataHandler.DBOracleManupulation.RecordSet("select * from CURRENCYCODE");// where Curr='BDT'
                                        ...
                                        if (objSTD.TRNDESC.Contains("Installment Amount"))
                                        {
                                            if (dr[l].Table.Columns.Contains("FR"))
                                            {
                                                if (dr[l]["FR"].ToString() != "")
                                        ...
                                        query = "Insert into STATEMENT_DETAILS(STATEMENTID,CONTRACTNO,IDCLIENT,PAN,ACCOUNTNO,STATEMENTNO,TRNDATE,POSTDATE,TRNDESC,ACURN,AMOUNT,OC,ORGAMOUNT,AMOUNTSIGN,APPROVAL,FR,P,DOCNO)" +
                                            ...
                                            "'" + objSTD.POSTDATE + "','" + objSTD.TRNDESC + "','" + objSTD.ACURN + "','" + objSTD.AMOUNT + "','" + objSTD.OC + "','" + objSTD.ORGAMOUNT + "','" + objSTD.AMOUNTSIGN + "','" + objSTD.APPROVAL + "','" + objSTD.FR + "','" + objSTD.P + "','" + objSTD.DOCNO + "')";
                                ...
                                if (objSt.SUM_INTEREST != "0.00")
                                {
                                    ...
                                    query = "Insert into STATEMENT_DETAILS(STATEMENTID,CONTRACTNO,IDCLIENT,PAN,ACCOUNTNO,STATEMENTNO,TRNDATE,POSTDATE,TRNDESC,ACURN,AMOUNT,APPROVAL,AMOUNTSIGN)" +
                                            " VALUES('" + objSTD.STATEMENTID + "','" + objSTD.CONTRACTNO + "','" + objSTD.IDCLIENT + "','" + objSTD.PAN + "','" + objSTD.ACCOUNTNO + "','" + objSTD.STATEMENTNO + "','" + objSTD.TRNDATE + "'," +
                                ...
                                else
                                {
                                  ...
                                  //  DataSet dsAcI = objProvider.ReturnData("select * from ACCUM_BODY_VW", ref reply);
                                    DataSet dsAcI = dbHelper.DBOracleManupulation.RecordSetCollection("select * from ACCUM_BODY_VW", reply);
                                                        ...
                                                        if (dtAcI.Rows[x][0].ToString() != "0.00")
                                                        {
                                                          ...
                                                          //  reply = objProvider.RunQuery(sql);
                                                           // if (!reply.Contains("Success"))
                                                            ...
                                                            dt = dataHandler.DBOracleManupulation.RecordSet("select AMOUNT from STATEMENT_DETAILS WHERE STATEMENTNO= '" + objSTD.STATEMENTNO + "' AND CONTRACTNO= '" + objSTD.CONTRACTNO + "' AND TRNDESC= 'Interest Charges' ");
                    ...
                    else
                    {
                        ...
                        //New View add
                     //   DataSet dsAcI = objProvider.ReturnData("select * from ACCUM_BODY_VW", ref reply);
                        DataSet dsAcI = dataHandler.DBOracleManupulation.RecordSetCollection("select * from ACCUM_BODY_VW",reply);
           ...
           // string sql = string.Empty;
            ...
            for (int k = 0; k < dtStatement.Rows.Count; k++)
            {
                ...
                try
                {
                   ...
                   // reply = objProvider.RunQuery(query);
                    result = dbHelper.DBOracleManupulation.Execute(query, UUL.UDBH.QuaryType.Complex);
                    //DataTable dtOperation = dsStatement.Tables["Operation"];
                    if (dtOperation != null && dtOperation.Columns.Contains("ACCOUNT"))
                    {
                               ...
                               // double feesnCharges = 0.00;
                                ...
                                else
                                {
                                   ...
                                   // DataSet dsAcI = objProvider.ReturnData("select * from ACCUM_BODY_VW WHERE ACURN='" + objSt.ACURN + "'", ref reply);
                                    DataSet dsAcI = dbHelper.DBOracleManupulation.RecordSetCollection("select * from ACCUM_BODY_VW WHERE ACURN='" + objSt.ACURN + "'",reply);
                                    if (dsAcI != null)
                                    {
                                        if (dsAcI.Tables.Count > 0)
                                        {
