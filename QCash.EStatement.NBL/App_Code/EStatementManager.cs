...
namespace StatementGenerator.App_Code
{
    public class EStatementManager
    {
        ...
        {
            return EStatementDataProvider.Instance().GetAllEmail(ref reply);
        }


        public StatementRegisterList GetStatementRegister(string stdate, ref string reply)
        {
            return EStatementDataProvider.Instance().GetStatementRegister(stdate, ref reply);
        }
        ...
        {
            return EStatementDataProvider.Instance().ArchiveStatement(ref reply);
        }
        #endregion
    }
}
