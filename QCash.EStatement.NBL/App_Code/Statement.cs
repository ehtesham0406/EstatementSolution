...
namespace StatementGenerator
{
    public class Statement
    {
        ...
        private string _PTEXTJOB;

        public string PTEXTJOB
        {
            get { return _PTEXTJOB; }
            set { _PTEXTJOB = value; }
        }
        ...
        private string _PROMOTIONALTEXTVALUE;

        public string PROMOTIONALTEXTVALUE
        {
            get { return _PROMOTIONALTEXTVALUE; }
            set { _PROMOTIONALTEXTVALUE = value; }
        }
