...
using QCash.EStatement.CBBL;
using CrystalDecisions.CrystalReports.Engine;
using FlexiStar.Utilities.EncryptionEngine;
using QCash.EStatement.CBBL.Reports;
...
using PdfSharp.Pdf;
//using QCash.EStatement.CBBL.App_Code;
    ...
    public partial class EStatementGenerator : Form
    {
        ...
        private void SendMail()
        {
            ...
            try
            {
                    ...
                    if (objESList.Count > 0)
                    {
                        ...
                        if (objSmtpList != null)
                        {
                            if (objSmtpList.Count > 0)
                            {
                                ...
                                for (int i = 0; i < objESList.Count; i++)
                                {
                                    if (objESList[i].MAILADDRESS != "")
                                    {
                                        try
                                        {
                                            ...
                                            objLW.logTrace(_LogPath, "EStatement.log", System.DateTime.Now.ToString("MMMM dd, yyyy h:mm:tt") + " : Sending EStatement to" + mail.To.ToString());
                                ...
                                objLW.logTrace(_LogPath, "EStatement.log", System.DateTime.Now.ToString("MMMM dd, yyyy h:mm:tt") + " : Total " + count.ToString() + " Estatement has mailed out of" + objESList.Count + ".");
                            }
                        }
                    }
                }
                ...
                {
                    txtAnalyzer.Invoke(_addText, new object[] { System.DateTime.Now.ToString("MMMM dd, yyyy h:mm:tt") + " : There is no Estatement has generated on that statement date." });
                    objLW.logTrace(_LogPath, "EStatement.log", System.DateTime.Now.ToString("MMMM dd, yyyy h:mm:tt") + " : There is no Estatement has generated on that statement date.");
        ...
        void btnGenerate_Click(object sender, EventArgs e)
        {
            ...
            dtCardbdt = objProvider.ReturnData("select * from Qry_Card_Account where Curr='BDT'", ref reply).Tables[0];
            ...
            /* USD SHOULD BE PRINT IN BDT FOR CBBL //CHNG
            ...
            if (ds != null)
            {
                if (ds.Tables.Count > 0)
                {
                    if (ds.Tables[0].Rows.Count > 0)
                    {
                        ...
                        filePath = _EStatementProcessedPath + "\\EStatement of " + System.DateTime.Now.ToString("ddMMyyyy") + "_BDT";
                        ...
                        {
                            if (dtCards.Rows[j]["CONTRACTNO"].ToString().Trim() != "")
                            {
                                //if (dtCards.Rows[j]["EMAIL"].ToString().Trim() != "")
                                //{
                                //    if (IsValid(dtCards.Rows[j]["EMAIL"].ToString().Trim()))
                                //    {
                                // if (dtCards.Rows[j]["LASTBAL"].ToString().Trim() != "0.00")
                                //{
                                try
                                {
                                    stmdt = new DataTable();
                                    ...
                                    if (stmdt.Rows.Count > 0)
                                    {
                                        ...
                                        // fileName = _fiid +"_"+cardType+"_EStatement_"+ dtCards.Rows[j]["idclient"].ToString() + "_" + dtCards.Rows[j]["pan"].ToString().Substring(0, 6) + "_" + dtCards.Rows[j]["pan"].ToString().Substring(12, 4) + "_BDT.pdf";
                                       ...
                                       // fileName = _fiid + "_" + dtCards.Rows[j]["pan"].ToString().Substring(0, 6) + "_" + dtCards.Rows[j]["CONTRACTNO"].ToString().Substring(0, 4) + dtCards.Rows[j]["ACCOUNTNO"].ToString().Substring(acc_no.Length - 5, 5) + "_" + dtCards.Rows[j]["idclient"].ToString() + "_" + "050" + ".PDF";
                                        ...
                                        // Parse the STATEMENT_DATE safely
                                        DateTime statementDate = DateTime.ParseExact(
                                            dtCards.Rows[j]["STDATE"].ToString(),"dd/MM/yyyy",System.Globalization.CultureInfo.InvariantCulture);

                                        string monthYear = statementDate.ToString("MMM-yyyy", System.Globalization.CultureInfo.InvariantCulture);

                                           fileName = _fiid + "_"
                                            + dtCards.Rows[j]["pan"].ToString().Substring(0, 6) + "_"
                                            + dtCards.Rows[j]["CONTRACTNO"].ToString().Substring(0, 4)
                                            + dtCards.Rows[j]["ACCOUNTNO"].ToString().Substring(acc_no.Length - 5, 5) + "_"
                                            + dtCards.Rows[j]["idclient"].ToString() + "_"
                                            + "050-" + monthYear + ".PDF";


                                        //fileName = _fiid + "_VISA_EStatement_" + dtCards.Rows[j]["idclient"].ToString() + "_" + dtCards.Rows[j]["pan"].ToString().Substring(0, 6) + "_" + dtCards.Rows[j]["pan"].ToString().Substring(10, 6) + "_BDT.pdf";
                                        //fileName = dtCards.Rows[j]["pan"].ToString().Substring(0, 4) + " " + dtCards.Rows[j]["pan"].ToString().Substring(4, 4) + " " + dtCards.Rows[j]["pan"].ToString().Substring(8, 4) + " " + dtCards.Rows[j]["pan"].ToString().Substring(12, 4) + ".pdf";
                                        ...
                                        for (int i = 0; i < document.Pages.Count; ++i)
                                        {
                                            ...
                                            XRect layoutRectangle = new XRect(245 /*X*/ , 775 /*Y*/ , page.Width /*Width*/ , font.Height /*Height*/ );
                                        ...
                                        //objEst.ACURN = stmdt.Rows[0]["ACURN"].ToString();
                                ...
                                //else
                                //{
                                //    txtAnalyzer.Invoke(_addText, new object[] { System.DateTime.Now.ToString("MMMM dd, yyyy h:mm:tt") + " : Outstanding is Zero. " + dtCards.Rows[j]["EMAIL"].ToString().Trim() + " \n : Estatement has not been created for Card# " + dtCards.Rows[j]["PAN"].ToString().Substring(0, 6) + "******" + dtCards.Rows[j]["PAN"].ToString().Substring(12, 4) });
                                //    objLW.logTrace(_LogPath, "EStatement.log", System.DateTime.Now.ToString("MMMM dd, yyyy h:mm:tt") + " : Outstanding is Zero. " + dtCards.Rows[j]["EMAIL"].ToString().Trim() + " \n : Estatement has not been created for Card# " + dtCards.Rows[j]["PAN"].ToString().Substring(0, 6) + "******" + dtCards.Rows[j]["PAN"].ToString().Substring(12, 4));
                        ...
                        txtAnalyzer.Invoke(_addText, new object[] { System.DateTime.Now.ToString("MMMM dd, yyyy h:mm:tt") + " : Total " + count.ToString() + " e-statements have been generated out of " + dtCards.Rows.Count + "." });
                        objLW.logTrace(_LogPath, "EStatement.log", System.DateTime.Now.ToString("MMMM dd, yyyy h:mm:tt") + " : Total " + count.ToString() + " e-statements have been generated out of " + dtCards.Rows.Count + ".");
                    }
                }
            }
        }
              ...
              if (ds != null)
              {
                  if (ds.Tables.Count > 0)
                  {
                      if (ds.Tables[0].Rows.Count > 0)
                      {
                          ...
                          filePath = _EStatementProcessedPath + "\\EStatement of " + System.DateTime.Now.ToString("ddMMyyyy") + "_USD";
                          ...
                          for (int j = 0; j < dtCards.Rows.Count; j++)//dtCards.Rows.Count
                          {
                              if (dtCards.Rows[j]["CONTRACTNO"].ToString().Trim() != "")
                              {
                                  ...
                                  {
                                      stmdt = new DataTable();
                                      stmdt = objProvider.ReturnData("select * from statement_USD where CONTRACTNO='" + dtCards.Rows[j]["CONTRACTNO"].ToString() + "'order by SL,autoid", ref reply).Tables[0];
                                      if (stmdt.Rows.Count > 0)
                                      {
                                          EStatement objst = new EStatement();
                                          objst.SetDataSource(stmdt);
                                          ...
                                          for (int i = 0; i < document.Pages.Count; ++i)
                                          {
                                              ...
                                              XRect layoutRectangle = new XRect(245 , 775 , page.Width , font.Height);
                                              using (XGraphics gfx = XGraphics.FromPdfPage(page))
                                              {
                          ...
                          txtAnalyzer.Invoke(_addText, new object[] { System.DateTime.Now.ToString("MMMM dd, yyyy h:mm:tt") + " : Total " + count.ToString() + " e-statements have been mailed out of " + dtCards.Rows.Count + "." });
                          objLW.logTrace(_LogPath, "EStatement.log", System.DateTime.Now.ToString("MMMM dd, yyyy h:mm:tt") + " : Total " + count.ToString() + " e-statements have been mailed out of " + dtCards.Rows.Count + ".");
                      }
                  }
              }
          }*/
        ...
        private void ProcessData()
        {
            ...
            {
                if (dia[fcount].FullName.Contains("CBBL"))
                {
                    _bankName = "CBBL";
                    _bankCode = "2";
        ...
        private void ProcessFolderFiles(string _SourcePath, string BankCode, string BankName, ref string _reply)
        {
            ...
            try
            {
                        ...
                        if (dsXML.Tables.Count > 0)
                        {
                            ...
                            for (int i = 0; i < dsXML.Tables.Count; i++)
                            {
                                if (dsXML.Tables[i].TableName == "Statement")
                                {
                                    ...
                                    txtAnalyzer.Invoke(_addText, new object[] { System.DateTime.Now.ToString("MMMM dd, yyyy h:mm:tt") + " : CardHolder statement info Saved from XML..." + reply });
                                    objLW.logTrace(_LogPath, "EStatement.log", " : CardHolder statement info Saved from XML." + reply);
                                }
                                else if (dsXML.Tables[i].TableName == "Operation")
                                {
                                    reply = GetCardHolderTransactionInfo(dsXML.Tables[i]);
                                    txtAnalyzer.Invoke(_addText, new object[] { System.DateTime.Now.ToString("MMMM dd, yyyy h:mm:tt") + " : CardHolder Operation info Saved from XML..." + reply });
                                    objLW.logTrace(_LogPath, "EStatement.log", " : CardHolder Operation info Saved from XML." + reply);
                                }
                                else if (dsXML.Tables[i].TableName == "Account")
                                {
                                    reply = GetCardHolderAccountInfo(dsXML.Tables[i]);
                                    txtAnalyzer.Invoke(_addText, new object[] { System.DateTime.Now.ToString("MMMM dd, yyyy h:mm:tt") + " : CardHolder Account info Saved from XML..." + reply });
                                    objLW.logTrace(_LogPath, "EStatement.log", " : CardHolder Account info Saved from XML." + reply);
                                }
                                else if (dsXML.Tables[i].TableName == "Card")
                                {
                                    reply = GetCardHolderCardInfo(dsXML.Tables[i]);
                                    txtAnalyzer.Invoke(_addText, new object[] { System.DateTime.Now.ToString("MMMM dd, yyyy h:mm:tt") + " : CardHolder Card info Saved from XML..." + reply });
                                    objLW.logTrace(_LogPath, "EStatement.log", " : CardHolder Card info Saved from XML." + reply);
                                }
                            ...
                            if (reply == "Success")
                            {
                                for (int i = 0; i < dsXML.Tables.Count; i++)
                                {
                                    if (dsXML.Tables[i].TableName == "Operation")
                                        GenerateStatementInfo(dsXML, BankName, fi[f].FullName, ref reply);
                                }
                            }
                        }
                        txtAnalyzer.Invoke(_addText, new object[] { System.DateTime.Now.ToString("MMMM dd, yyyy h:mm:tt") + " : Total " + dsXML.Tables["Card"].Rows.Count.ToString() + " record found to process.." });
                        objLW.logTrace(_LogPath, "EStatement.log", " : Total " + dsXML.Tables["Card"].Rows.Count.ToString() + " record found to process..");
                    }
                    #endregion

                    txtAnalyzer.Invoke(_addText, new object[] { System.DateTime.Now.ToString("MMMM dd, yyyy h:mm:tt") + " : " + fi[f].Name + " data capture complete.." });
                    objLW.logTrace(_LogPath, "EStatement.log", " : " + fi[f].Name + " data capture complete..");
                    txtAnalyzer.Invoke(_addText, new object[] { "\n" });
                ...
                if (Directory.Exists(_SourcePath))
                {
                    ...
                    {
                        txtAnalyzer.Invoke(_addText, new object[] { System.DateTime.Now.ToString("MMMM dd, yyyy h:mm:tt") + " : Source Directory moving Error. " + ex.Message });
        ...
        //
        private void GenerateStatementInfo(DataSet dsStatement, string BankName, string filename, ref string errMsg)
        {
            string reply = string.Empty;
            ...
            {
                txtAnalyzer.Invoke(_addText, new object[] { System.DateTime.Now.ToString("MMMM dd, yyyy h:mm:tt") + " : " + ex.Message + ", Problem in file: " + filename });
                MsgLogWriter objLW = new MsgLogWriter();
                objLW.logTrace(_LogPath, "EStatement.log", ex.Message);
                errMsg = ex.StackTrace;
            }
                                ...
                                for (int l = 0; l < dr.Length; l++)
                                {
                                    ...
                                    if (INTlist.Contains(dr[l]["D"].ToString().ToUpper()) == false)
                                    {
                                        ...
                                        if (dr[l].Table.Columns.Contains("TD"))
                                        {
                                            ...
                                            // Check if TRNDATE is null or empty  //CHNG
                                            if (!string.IsNullOrEmpty(objSTD.TRNDATE))
                                            {
                                                string[] tddate = objSTD.TRNDATE.Split('/');

                                                objSTD.TRNDATE = tddate[0].ToString() + '/' + tddate[1].ToString() + '/' + tddate[2].ToString().Substring(0, 4);
                                        ...
                                        if (dr[l].Table.Columns.Contains("OD"))
                                        {
                                            ...
                                            // Check if TRNDATE is null or empty  //CHNG
                                            if (!string.IsNullOrEmpty(objSTD.POSTDATE))
                                            {
                                                string[] pddate = objSTD.POSTDATE.Split('/');

                                                objSTD.POSTDATE = pddate[0].ToString() + '/' + pddate[1].ToString() + '/' + pddate[2].ToString().Substring(0, 4);
                                        ...
                                        else
                                        {
                                            if (dr[l].Table.Columns.Contains("TL"))
                                            {
                                                ...
                                                if (dr[l]["FR"].ToString().ToUpper().Contains("A 20") || dr[l]["FR"].ToString().ToUpper().Contains("A 10") || dr[l]["FR"].ToString().ToUpper().Contains("A 64") || dr[l]["FR"].ToString().ToUpper().Contains("P 14") || dr[l]["FR"].ToString().ToUpper().Contains("P 32") || dr[l]["FR"].ToString().ToUpper().Contains("P 33") || dr[l]["FR"].ToString().ToUpper().Contains("F 29") || dr[l]["FR"].ToString().ToUpper().Contains("P 13"))
                                                {
                                                    ...
                                                    {
                                                        objSTD.TRNDESC = dr[l]["D"].ToString().Replace("'", "''") + ": " + dr[l]["TL"].ToString().Replace("'", "''");
                                                        if (objSTD.TRNDESC.Length > 57) //CHNG
                                                        {
                                                            objSTD.TRNDESC = objSTD.TRNDESC.Substring(0, 57) + " [" + objSTD.OC + " : " + Convert.ToDecimal(dr[l]["OA"]).ToString("0.00") + "]";
                                                        }
                                                        else
                                                        {
                                        ...
                                        if (dr[l].Table.Columns.Contains("FR"))
                                        {
                                            ...
                                            {
                                                objSTD.TRNDESC = "QR TXN : " + " " + dr[l]["TL"].ToString().Replace("'", "''");
                                            }
                                        }
                                        ...
                                        #region  #region CARD ANNUAL FEE

                                        if (dr[l]["D"].ToString().ToUpper() == "CARD ANNUAL FEES" && (objSTD.AMOUNT == "0.00" || objSTD.AMOUNT == "0"))
                                        {
                                            if (dr[l].Table.Columns.Contains("FR"))
                                            {
                                                if (dr[l]["FR"].ToString() == "" || dr[l]["FR"].ToString() == null)
                                                ...
                                                else if (dr[l]["FR"].ToString().ToUpper() == "CARD MAINTENANCE FEE WAIVED [1ST YEAR FREE]" || dr[l]["FR"].ToString().ToUpper() == "CARD MAINTENANCE FEE WAIVED [15 TRANSACTIONS]")
                                                {
                                        ...
                                        else if (objSTD.AMOUNT == "0.00" || objSTD.AMOUNT == "0")
                                        {
                                            continue; // Skip the iteration if D is not "CARD ANNUAL FEES" but AMOUNT is "0.00" or "0"
                                        }
