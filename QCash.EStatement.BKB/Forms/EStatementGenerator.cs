...
using QCash.EStatement.BKB;
using CrystalDecisions.CrystalReports.Engine;
using FlexiStar.Utilities.EncryptionEngine;
using QCash.EStatement.BKB.Reports;
...
namespace StatementGenerator
{
    public partial class EStatementGenerator : Form
    {
        ...
        private void ProcessStatementBDT(DataTable dtCards)
        {
            ...
            string filePath_Email = string.Empty;
            string filePath_NoEmail = string.Empty;
            string filePath_InvalidEmail = string.Empty;
            ...
            if (ds != null)
            {
                if (ds.Tables.Count > 0)
                {
                    if (ds.Tables[0].Rows.Count > 0)
                    {
                        ...
                        filePath_Email = _EStatementProcessedPath + "\\EStatement of " + System.DateTime.Now.ToString("ddMMyyyy") + "_Email";
                        filePath_NoEmail = _EStatementProcessedPath + "\\EStatement of " + System.DateTime.Now.ToString("ddMMyyyy") + "_NoEmail";
                        filePath_InvalidEmail = _EStatementProcessedPath + "\\EStatement of " + System.DateTime.Now.ToString("ddMMyyyy") + "_InvalidEmail";


                        if (!Directory.Exists(filePath_Email))
                        {
                            Directory.CreateDirectory(filePath_Email);
                        }

                        if (!Directory.Exists(filePath_NoEmail))
                        {
                            Directory.CreateDirectory(filePath_NoEmail);
                        }

                        if (!Directory.Exists(filePath_InvalidEmail))
                        {
                            Directory.CreateDirectory(filePath_InvalidEmail);
                        }
                                    ...
                                    try
                                    {
                                        ...
                                        if ((dtCards.Rows[j]["pan"].ToString()) != vPAN)
                                        {
                                            ...
                                            if (stmdt.Rows.Count > 0)
                                            {
                                                ...
                                                //objst.ExportToDisk(ExportFormatType.PortableDocFormat, filePath_Email + "\\" + fileName);
                                                ...
                                                // Save the document...
                                                document.Save(filePath_Email + "\\" + fileName);
                                                ...
                                                objEst.FILE_LOCATION = filePath_Email + "\\" + fileName;
                                    ...
                                    try
                                    {
                                        ...
                                        if ((dtCards.Rows[j]["pan"].ToString()) != vPAN)
                                        {
                                            ...
                                            if (stmdt.Rows.Count > 0)
                                            {
                                                ...
                                                // Save the document...
                                                document.Save(filePath_InvalidEmail + "\\" + fileName);
                                                ...
                                                objEst.FILE_LOCATION = filePath_InvalidEmail + "\\" + fileName;
                                                objEst.MAILSUBJECT = txtEmailSubject.Text.Replace("'", "''");
                                                objEst.MAILBODY = txtEmailBody.Text.Replace("'", "''");
                                                objEst.STATUS = "1";
                                ...
                                try
                                {
                                    ...
                                    if ((dtCards.Rows[j]["pan"].ToString()) != vPAN)
                                    {
                                        ...
                                        if (stmdt.Rows.Count > 0)
                                        {
                                            ...
                                            // Save the document...
                                            document.Save(filePath_NoEmail + "\\" + fileName);
                                            ...
                                            objEst.FILE_LOCATION = filePath_NoEmail + "\\" + fileName;
                                            objEst.MAILSUBJECT = txtEmailSubject.Text.Replace("'", "''");
                                            objEst.MAILBODY = txtEmailBody.Text.Replace("'", "''");
                                            objEst.STATUS = "1";
        ...
        private void ProcessData()
        {
            ...
            {
                if (dia[fcount].FullName.Contains("BKB"))
                {
                    _bankName = "BKB";
                    _bankCode = "14";
                ...
                for (int k = 0; k < dtGetAccumIntAcc.Rows.Count; k++)
                {
                    ...
                    for (int j = 0; j < dtGetAccumIntAcc.Columns.Count; j++)
                    {
                        ...
                        else if (dtGetAccumIntAcc.Columns[j].ColumnName == "ACCUM_INT_EBALANCE")
                        {
                            ...
                            objOp.ACCUM_INT_EBALANCE = Convert.ToDecimal(dtGetAccumIntAcc.Rows[k][j]);
                        }
                        else if (dtGetAccumIntAcc.Columns[j].ColumnName == "ACCUM_INT_SBALANCE")
                        {
                            ...
                            objOp.ACCUM_INT_SBALANCE = Convert.ToDecimal(dtGetAccumIntAcc.Rows[k][j]);
                        }
                                        ...
                                        if (dr[l].Table.Columns.Contains("ACURN"))
                                        {
                                            if (dr[l]["A"].ToString() == "" || dr[l]["A"].ToString() == null)
                                               ...
                                               // objSTD.AMOUNT =Convert.ToDecimal( dr[l]["A"]) * (-1);
                                                // objSTD.AMOUNT = Convert.ToDecimal(dr[l]["A"]);
                                                ...
                                                for (int x = 0; x < dtAcI.Rows.Count; x++)
                                                {
                                                    ...
                                                    if (objSTD.CONTRACTNO == dtAcI.Rows[x][1].ToString())
                                                    {
                                                        if (dtAcI.Rows[x][0].ToString() != "0.00")
                                                        {
                                                            ...
                                                            objSTD.ACURN = objSt.ACURN;
                                                            objSTD.TRNDESC = "INTEREST CHARGES";
                                                           // objSTD.AMOUNT = Convert.ToDecimal(dtAcI.Rows[x][0].ToString());
                        ...
                        if (dtOperation.Rows.Count > 0)
                        {
                            ...
                            if (dr.Length > 0)
                            {
                                ...
                                for (int l = 0; l < dr.Length; l++)
                                {
                                    ...
                                    if (INTlist.Contains(dr[l]["D"].ToString().ToUpper()) == false)
                                    {
                                        ...
                                        if (dr[l].Table.Columns.Contains("ACURN"))
                                        {
                                            ...
                                            //objSTD.AMOUNT = Convert.ToDecimal(dr[l]["A"].ToString());
                                            objSTD.AMOUNT = dr[l]["A"].ToString();
                                        }
                                        else 
                                           // objSTD.AMOUNT =Convert.ToDecimal("0.00");
                                ...
                                if (objSt.SUM_INTEREST != "0.00")
                                {
                                    ...
                                    objSTD.TRNDESC = "INTEREST CHARGES";
                                    //objSTD.TRNDESC = "Profit Charges";
                                  //  objSTD.AMOUNT =Convert.ToDecimal(objSt.SUM_INTEREST);
                                    objSTD.AMOUNT = "-" + objSt.SUM_INTEREST;//.PadLeft(objSt.SUM_INTEREST.Length+1,'-');
                                    objSTD.TRNDATE = trn_Date;
                                    objSTD.POSTDATE = trn_Date;
