...
using Common;
using QCash.EStatement.GIB.Reports;
...
namespace StatementGenerator
{
    public partial class EStatementGenerator : Form
    {
                                              ...
                                              //  string Bin = dtCards.Rows[j]["pan"].ToString().Substring(0, 6);
                                               // fileName = _fiid + "_" + Bin + "_" + stmdt.Rows[0]["Statement_Date"].ToString().Replace('/', '-') + "_" + pdfCount + ".pdf";
                                                ...
                                                for (int i = 0; i < document.Pages.Count; ++i)
                                                {
                                                    ...
                                                    XRect layoutRectangle = new XRect(198 /*X*/ , 201 /*Y*/ , page.Width /*Width*/ , font.Height /*Height*/ );
        ...
        private void ProcessData()
        {
            ...
            {
                if (dia[fcount].FullName.Contains("GIB"))
                {
                    _bankName = "GIB";
                    _bankCode = "21";
                ...
                //    ProcessFolderFiles(_XMLSourcePath, _bankCode, _bankName, ref _reply);
                //}
                else if (dia[fcount].FullName.Contains("NRBG"))
                {
                    _bankName = "NRBG";
                    _bankCode = "8";
                    _XMLSourcePath = dia[fcount].FullName;
                        ...
                        if (dsXML.Tables.Count > 0)
                        {
                            ...
                            for (int i = 0; i < dsXML.Tables.Count; i++)
                            {
                                ...
                                else if (dsXML.Tables[i].TableName == "AccumIntAcc")
                                {
                                    ...
                                    txtAnalyzer.Invoke(_addText, new object[] { System.DateTime.Now.ToString("MMMM dd, yyyy h:mm:tt") + " : CardHolder AccumInt Info data Saved from XML. " + reply });
