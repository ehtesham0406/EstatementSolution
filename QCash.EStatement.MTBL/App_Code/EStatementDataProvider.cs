    ...
    public class EStatementDataProvider : IEStatement
    {
       ...
       // private SetTextCallback _addText = null;
        ...
        public string AddEStatement(EStatementInfo objEst, ref string reply)
        {
            ...
            ConStr = new ConnectionStringBuilder(1);
            objProvider = new SqlDbProvider(ConStr.ConnectionString_DBConfig);
            objLW.logTrace(_LogPath, "EStatement.log", System.DateTime.Now.ToString("MMMM dd, yyyy h:mm:ss tt") + " : Database Info - " + ConStr.ConnectionString_DBConfig);
            ...
            objLW.logTrace(_LogPath, "EStatement.log", System.DateTime.Now.ToString("MMMM dd, yyyy h:mm:ss tt") + " : Insert Email data Parameter obj log - " + "PAN :- " + objEst.PAN_NUMBER + "','" + " STATUS:- " + objEst.STATUS + "','" + " FILE_LOCATION:- " + objEst.FILE_LOCATION + "','" + " EMAIL ID :- " + objEst.MAILADDRESS);
            objLW.logTrace(_LogPath, "EStatement.log", System.DateTime.Now.ToString("MMMM dd, yyyy h:mm:ss tt") + " : Insert Email DB insert  STATUS log: " + _reply);
            return _reply;
        }
        ...
        public string UpdateEStatement(EStatementInfo objEst, ref string reply)
        {
            ...
            objLW.logTrace(_LogPath, "EStatement.log", System.DateTime.Now.ToString("MMMM dd, yyyy h:mm:ss tt") + " : Database Info - " + ConStr.ConnectionString_DBConfig);
            string _reply = string.Empty;
            _reply = objProvider.RunQuery("update email_notification set  status='" + objEst.STATUS + "' where bank_code='" + objEst.BANK_CODE + "' and pan_number='" + objEst.PAN_NUMBER + "' and stmdate='" + objEst.STMDATE + "' and file_location='" + objEst.FILE_LOCATION + "'");

            objLW.logTrace(_LogPath, "EStatement.log", System.DateTime.Now.ToString("MMMM dd, yyyy h:mm:ss tt") + " : Update Email data Parameter obj log - " + "PAN :- " + objEst.PAN_NUMBER + "','" + " STATUS:- " + objEst.STATUS + "','" + "FILE_LOCATION:- " + objEst.FILE_LOCATION + "','" + " EMAIL ID:- " + objEst.MAILADDRESS);
            objLW.logTrace(_LogPath, "EStatement.log", System.DateTime.Now.ToString("MMMM dd, yyyy h:mm:ss tt") + " : Update Email DB update log: " + _reply);
            return _reply;
        }
