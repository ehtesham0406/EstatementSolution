...
using QCash.EStatement.BAL.App_Code;
using System.Globalization;
using QCash.EStatement.BALISLAMIC.Reports;
...
namespace StatementGenerator
{
    public partial class EStatementGenerator : Form
    {
            ...
            if (ds != null)
            {
                if (ds.Tables.Count > 0)
                {
                    if (ds.Tables[0].Rows.Count > 0)
                    {
                        ...
                        filePath = _EStatementProcessedPath + "\\Islamic EStatement of " + System.DateTime.Now.ToString("ddMMyyyy") + "_BDT";
                        ...
                        for (int j = 0; j < dtCards.Rows.Count; j++)//dtCards.Rows.Count
                        {
                            if (dtCards.Rows[j]["CONTRACTNO"].ToString().Trim() != "")
                            {
                                ...
                                try
                                {
                                    ...
                                    stmdt = objProvider.ReturnData("select * from statement_BDT where CONTRACTNO='" + dtCards.Rows[j]["CONTRACTNO"].ToString() + "' ORDER BY [AutoID]", ref reply).Tables[0];

                                    if (stmdt.Rows.Count > 0)
                                    {
                                        EStatementBDT objst = new EStatementBDT();
                                        objst.SetDataSource(stmdt);

                                        /*   if ((dtCards.Rows[j]["pan"].ToString().Substring(0, 1) == "5") || (dtCards.Rows[j]["pan"].ToString().Substring(0, 1) == "2"))
                                           {
                                               cardType = "MASTER";
                                           }
                                           else if (dtCards.Rows[j]["pan"].ToString().Substring(0, 1) == "4")
                                           {
                                               cardType = "VISA";
                                        ...
                                        fileName = "BANK_ASIA" + "_" + dtCards.Rows[j]["pan"].ToString().Substring(0, 6) + "_" + dtCards.Rows[j]["CONTRACTNO"].ToString().Substring(0, 4) + dtCards.Rows[j]["ACCOUNTNO"].ToString().Substring(acc_no.Length - 5, 5) + "_" + dtCards.Rows[j]["idclient"].ToString() + "_" + "050" + ".PDF";
            ...
            if (ds != null)
            {
                if (ds.Tables.Count > 0)
                {
                    if (ds.Tables[0].Rows.Count > 0)
                    {
                        ...
                        filePath = _EStatementProcessedPath + "\\Islamic EStatement of " + System.DateTime.Now.ToString("ddMMyyyy") + "_USD";
                        ...
                        for (int j = 0; j < dtCards.Rows.Count; j++)//dtCards.Rows.Count
                        {
                            if (dtCards.Rows[j]["CONTRACTNO"].ToString().Trim() != "")
                            {
                                ...
                                {
                                    stmdt = new DataTable();
                                    stmdt = objProvider.ReturnData("select * from statement_USD where CONTRACTNO='" + dtCards.Rows[j]["CONTRACTNO"].ToString() + "' ORDER BY [AutoID]", ref reply).Tables[0];
                                    if (stmdt.Rows.Count > 0)
                                    {
                                        EStatementUSD objst = new EStatementUSD();
                                        objst.SetDataSource(stmdt);
                                        ...
                                        // fileName = _fiid +"_"+cardType+"_EStatement_"+ dtCards.Rows[j]["idclient"].ToString() + "_" + dtCards.Rows[j]["pan"].ToString().Substring(0, 6) + "_" + dtCards.Rows[j]["pan"].ToString().Substring(12, 4) + "_USD.pdf";

                                        string acc_no = dtCards.Rows[j]["ACCOUNTNO"].ToString();
                                        fileName = "BANK_ASIA" + "_" + dtCards.Rows[j]["pan"].ToString().Substring(0, 6) + "_" + dtCards.Rows[j]["CONTRACTNO"].ToString().Substring(0, 4) + dtCards.Rows[j]["ACCOUNTNO"].ToString().Substring(acc_no.Length - 5, 5) + "_" + dtCards.Rows[j]["idclient"].ToString() + "_" + "840" + ".PDF";



                                        //fileName = _fiid + "_VISA_EStatement_" + dtCards.Rows[j]["idclient"].ToString() + "_" + dtCards.Rows[j]["pan"].ToString().Substring(0, 6) + "_" + dtCards.Rows[j]["pan"].ToString().Substring(10, 6) + "_USD.pdf";
                                        //fileName = dtCards.Rows[j]["pan"].ToString().Substring(0, 4) + " " + dtCards.Rows[j]["pan"].ToString().Substring(4, 4) + " " + dtCards.Rows[j]["pan"].ToString().Substring(8, 4) + " " + dtCards.Rows[j]["pan"].ToString().Substring(12, 4) + ".pdf";
                                        objst.ExportToDisk(ExportFormatType.PortableDocFormat, filePath + "\\" + fileName);
        ...
        private void ProcessData()
        {
            ...
            {
                if (dia[fcount].FullName.Contains("MBL"))
                {
                    _bankName = "NON";
                    _bankCode = "2";
                                ...
                                for (int l = 0; l < dr.Length; l++)
                                {
                                    ...
                                    if (INTlist.Contains(dr[l]["D"].ToString().ToUpper()) == false)
                                    {
                                        ...
                                        if (dr[l].Table.Columns.Contains("TD"))
                                        {
                                            ...
                                            // Check if TRNDATE is null or empty
                                        ...
                                        if ((dr[l]["D"].ToString().ToUpper().Contains("MONTHLY EMI")) || (dr[l]["D"].ToString().ToUpper().Contains("TRANSFER TO EMI")) || (dr[l]["D"].ToString().ToUpper().Contains("EMI CANCELLED")) || (dr[l]["D"].ToString().ToUpper().Contains("EMI")))
                                        {
                                            if (dr[l].Table.Columns.Contains("FR"))
                                            {
                                        ...
                                        #region INTEREST ON MONTHLY EMI

                                        if ((objSTD.TRNDESC.ToUpper().Contains("INTEREST ON MONTHLY EMI")))
                                        {
                                            objSTD.TRNDESC = "PROFIT ON MONTHLY EMI";
                                        }
