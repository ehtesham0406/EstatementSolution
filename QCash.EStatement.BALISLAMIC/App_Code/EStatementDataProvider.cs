...
namespace StatementGenerator.App_Code
{
    public class EStatementDataProvider : IEStatement
    {
        ...
        //    _reply = objProvider.RunQuery("insert into email_notification values('" + objEst.BANK_CODE + "','" + objEst.PAN_NUMBER+ "','" + objEst.STMDATE + "','" + objEst.MONTH + "','" + objEst.YEAR + "','" + objEst.FILE_LOCATION + "','" + objEst.MAILADDRESS + "','" + objEst.MAILSUBJECT + "','" + objEst.MAILBODY + "','" + objEst.STATUS +"','"+objEst.CLIENT +"','"+objEst.IDCLIENT+"','"+objEst.ACURN+ "')");
        //    return _reply;
        //}
        public string AddEStatement(EStatementInfo objEst, ref string reply)
        {
        ...
        //    objProvider = new SqlDbProvider(ConStr.ConnectionString_DBConfig);
        //    string _reply = string.Empty;
        //    _reply = objProvider.RunQuery("update email_notification set  status='" + objEst.STATUS + "' where bank_code='" + objEst.BANK_CODE + "' and pan_number='" + objEst.PAN_NUMBER + "'and ACURN= '"+objEst.ACURN + "' and stmdate='" + objEst.STMDATE + "'");
        //    return _reply;
        //}
        ...
        public string UpdateEStatement(EStatementInfo objEst, ref string reply)
        {
            ...
            objProvider = new SqlDbProvider(ConStr.ConnectionString_DBConfig);
            string _reply = string.Empty;
            _reply = objProvider.RunQuery("update email_notification set  status='" + objEst.STATUS + "' where bank_code='" + objEst.BANK_CODE + "' and pan_number='" + objEst.PAN_NUMBER + "' and FILE_LOCATION='" + objEst.FILE_LOCATION + "' and stmdate='" + objEst.STMDATE + "'");
            return _reply;
        }
